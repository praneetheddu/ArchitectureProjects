...
*/
void compute_stats() {
    stats.aat = (stats.reads + stats.writes) * MEMORY_READ_TIME;
    stats.aat += stats.page_faults * DISK_PAGE_READ_TIME;
    stats.aat += stats.writebacks * DISK_PAGE_WRITE_TIME;
    stats.aat /= stats.accesses;
